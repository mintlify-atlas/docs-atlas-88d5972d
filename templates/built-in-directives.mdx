...
Associates a renderable value with a unique key. When the key changes, the previous DOM is removed and a fresh instance is created, even if the template shape is the same.
